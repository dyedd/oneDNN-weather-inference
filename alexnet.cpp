...
void simple_net(engine::kind engine_kind, int times = 100, std::string img_name = "1.jpg")
{
        ...
        auto relu1_prim_desc = eltwise_forward::primitive_desc(eng, prop_kind::forward_inference,
        ...
        auto relu2_prim_desc = eltwise_forward::primitive_desc(eng, prop_kind::forward_inference,
        ...
        // create relu primitive and add it to net
        auto relu3_prim_desc = eltwise_forward::primitive_desc(eng, prop_kind::forward_inference,
        ...
        // create relu primitive and add it to net
        auto relu4_prim_desc = eltwise_forward::primitive_desc(eng, prop_kind::forward_inference,
        ...
        // create relu primitive and add it to net
        auto relu5_prim_desc = eltwise_forward::primitive_desc(eng, prop_kind::forward_inference,
